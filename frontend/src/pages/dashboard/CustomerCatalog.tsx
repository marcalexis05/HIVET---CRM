...
import { ShoppingCart, Tag, Star, Search, Filter as FilterIcon, Award, ArrowUp, Loader2, Store, Minus, Plus } from 'lucide-react';
                                ...
                                <div className="flex-1 flex flex-col px-2">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <div className="flex gap-0.5">
                                            {[...Array(5)].map((_, i) => (
                                                <Star key={i} className={`w-3 h-3 ${i < (p.stars || 5) ? 'text-brand fill-brand' : 'text-accent-brown/10'}`} />
                                            ))}
                                        </div>
                                    </div>
