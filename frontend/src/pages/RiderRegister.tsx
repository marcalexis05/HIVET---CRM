...
import {
    ...
    ShieldCheck, MailCheck, Bike, Eye, EyeOff, User
} from 'lucide-react';
...
const RiderRegister = () => {
    ...
    const handleRegister = async () => {
        ...
        setError('');
        try {
            // Note: Update this endpoint when the backend adds a specific rider registration route
            const res = await fetch('http://localhost:8000/api/auth/register', { 
                ...
                body: JSON.stringify({
                    ...
                    last_name: lastName,
                    phone,
                    role: 'rider', // Might be needed for backend to differentiate
            ...
            if (res.ok && data.token) {
                ...
                navigate('/dashboard/rider'); // Navigate to rider dashboard
            } else {
        ...
        switch (step) {
                ...
                return (
                    ...
                    >
                        ...
                        >
                            ...
                            <span>Apply easily with Google</span>
                        </button>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                ...
                                <div className="group space-y-2">
                                    ...
                                    <div className="relative">
                                        <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-accent-brown/20 group-focus-within:text-brand-dark transition-colors" />
                                        <input type="text" value={lastName} onChange={e => setLastName(e.target.value)} placeholder="Dela Cruz" className="w-full bg-accent-peach/20 border-2 border-transparent focus:border-brand/30 focus:bg-white rounded-[2rem] py-4 pl-11 pr-3 text-accent-brown font-semibold outline-none transition-all text-sm" />
                                    </div>
                                </div>
                            </div>
                            
                            {/* Driver License & Phone */}
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div className="group space-y-2">
                                    <label className="text-[10px] font-black text-accent-brown/40 uppercase tracking-[0.2em] pl-3">Driver's License (Optional)</label>
                                    <div className="relative">
                                        ...
                                        <input type="text" value={driverLicense} onChange={e => setDriverLicense(e.target.value)} placeholder="N01-XX-XXXXXX" className="w-full bg-accent-peach/20 border-2 border-transparent focus:border-brand/30 focus:bg-white rounded-[2rem] py-4 pl-11 pr-3 text-accent-brown font-semibold outline-none transition-all text-sm" />
                                    </div>
                                </div>
            ...
            case 2:
                return (
                    ...
                    >
                        <div className="space-y-2">
                            <h3 className="text-xl xs:text-2xl font-black text-accent-brown tracking-tighter">Courier Credentials</h3>
                            <p className="text-xs xs:text-sm text-accent-brown/50 font-medium italic">Secure access for your delivery app.</p>
                        </div>

                        <div className="space-y-4">
                            <div className="group space-y-2">
                                <label className="text-[10px] font-black text-accent-brown/40 uppercase tracking-[0.2em] pl-4">Account Email Address</label>
                                <div className="relative">
                                    ...
                                    <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="courier@example.com" className="w-full bg-accent-peach/20 border-2 border-transparent focus:border-brand/30 focus:bg-white rounded-[2rem] py-5 pl-16 pr-8 text-accent-brown font-semibold outline-none transition-all" />
                                </div>
                            </div>
                            <div className="group space-y-2">
                ...
                return (
                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-xl xs:text-2xl font-black text-accent-brown tracking-tighter">Courier Verification</h3>
            ...
            >
                ...
                <div className="hidden md:flex flex-col justify-between p-16 bg-accent-peach/30 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="space-y-4 max-w-sm">
                            <h1 className="text-4xl font-black text-accent-brown leading-tight">
                                Join our fleet <br />
                                <span className="text-brand-dark">and deliver</span> <br />
                                care today.
                            </h1>
                            <p className="text-accent-brown/60 font-medium leading-relaxed">
                                Connect pet parents with essential medications on your own schedule.
                            </p>
                        </div>
                    </div>

                    <div className="relative z-10">
                        {/* Could replace with a specific driver register hero image later */}
                        <motion.img
                            initial={{ y: 20, opacity: 0 }}
                            animate={{ y: 0, opacity: 1 }}
                            transition={{ delay: 0.2 }}
                            src="/images/register_hero.png"
                            alt="Courier Registration Illustration"
                    ...
                    <div className="relative z-10 flex gap-4">
                        <div className="bg-white/50 backdrop-blur-md px-6 py-3 rounded-full border border-white text-[10px] font-black uppercase tracking-widest text-accent-brown/40">
                            Driver Application - Step {step} of 3
                        </div>
                    </div>
                </div>
                ...
                <div className="p-6 xs:p-10 md:p-20 flex flex-col justify-center">
                    <div className="mb-10 flex items-center justify-between">
                        ...
                        <Link to="/login/rider" className="text-[10px] font-black text-brand-dark hover:text-brand transition-colors uppercase tracking-[0.2em] border-b-2 border-brand/20 pb-0.5">
                            Rider Login
                        </Link>
                    </div>
