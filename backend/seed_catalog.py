from main import SessionLocal, Product, BusinessProfile
from datetime import datetime

# Data from products.ts
products_data = [
    {
        "category": 'Dogs', "type": 'Food', "name": 'Grain-Free Alpine Salmon', "price": 85.00,
    ...
    {
        "category": 'Cats', "type": 'Food', "name": 'Raw Vitality Rabbit Feast', "price": 64.00,
    ...
    {
        "category": 'Dogs', "type": 'Food', "name": 'Puppy Growth Formula', "price": 55.00,
    ...
    {
        "category": 'Cats', "type": 'Food', "name": 'Indoor Weight Control', "price": 48.00,
    ...
    {
        "category": 'Dogs', "type": 'Food', "name": 'Senior Mobility Beef', "price": 72.00,
    ...
    {
        "category": 'Cats', "type": 'Food', "name": 'Sensitive Stomach Quail', "price": 68.00,
    ...
    {
        "category": 'Dogs', "type": 'Food', "name": 'High-Performance Bison', "price": 95.00,
    ...
    {
        "category": 'Cats', "type": 'Food', "name": 'Seafood Medley Pate', "price": 32.00,
    ...
    {
        "category": 'Dogs', "type": 'Food', "name": 'Sustainable Insect Protein', "price": 58.00,
    ...
    {
        "category": 'Cats', "type": 'Food', "name": 'Kitten First-Year Mousse', "price": 42.00,
    ...
    {
        "category": 'Dogs', "type": 'Accessories', "name": 'Leather Trekking Harness', "price": 145.00,
    ...
    {
        "category": 'Cats', "type": 'Accessories', "name": 'Scandinavian Cat Tree', "price": 340.00,
    ...
    {
        "category": 'Dogs', "type": 'Accessories', "name": 'Night-Safe Reflective Lead', "price": 45.00,
    ...
    {
        "category": 'Cats', "type": 'Accessories', "name": 'Ceramic Water Fountain', "price": 124.00,
    ...
    {
        "category": 'Dogs', "type": 'Accessories', "name": 'Orthopedic Memory Bed', "price": 195.00,
    ...
    {
        "category": 'Cats', "type": 'Accessories', "name": 'Premium Velvet Nest', "price": 89.00,
    ...
    {
        "category": 'Dogs', "type": 'Accessories', "name": 'Elevated Bamboo Bowls', "price": 78.00,
    ...
    {
        "category": 'Cats', "type": 'Accessories', "name": 'Interactive Puzzle Toy', "price": 45.00,
    ...
    {
        "category": 'Dogs', "type": 'Accessories', "name": 'Professional Travel Carrier', "price": 165.00,
    ...
    {
        "category": 'Cats', "type": 'Accessories', "name": 'Limited Velvet Collar', "price": 55.00,
    ...
    {
        "category": 'Dogs', "type": 'Vitamins', "name": 'Omega-3 Vitality Chew', "price": 32.00,
    ...
    {
        "category": 'Cats', "type": 'Vitamins', "name": 'Joint Support Glucosamine', "price": 44.00,
    ...
    {
        "category": 'Dogs', "type": 'Vitamins', "name": 'Daily Pet Vitamins', "price": 28.00,
    ...
    {
        "category": 'Cats', "type": 'Vitamins', "name": 'L-Lysine Immunity Boost', "price": 38.00,
    ...
    {
        "category": 'Dogs', "type": 'Vitamins', "name": 'Dental Care Enzymes', "price": 19.00,
    ...
    {
        "category": 'Cats', "type": 'Vitamins', "name": 'Multivitamin Soft Chews', "price": 24.00,
    ...
    {
        "category": 'Dogs', "type": 'Vitamins', "name": 'Sensitive Skin Remedy', "price": 52.00,
    ...
    {
        "category": 'Cats', "type": 'Vitamins', "name": 'Vision Advance Eyes', "price": 65.00,
    ...
    {
        "category": 'Dogs', "type": 'Vitamins', "name": 'Digestive Probiotic Blend', "price": 48.00,
    ...
    {
        "category": 'Cats', "type": 'Vitamins', "name": 'Urinary Tract Support', "price": 36.00,
...
def seed():
    ...
    try:
        ...
        if not biz:
            print("Business business@hivet.com not found. Please run insert_business script first.")
            return
            
        # Clean existing products for this business to avoid duplicates if re-run
        ...
        for p in products_data:
            new_p = Product(
                ...
                tag=p["tag"],
                stars=p["stars"],
                sku=f"{p['type'][:2].upper()}-{p['name'][:3].upper()}-{biz.id:03d}"
            )
            db.add(new_p)
        
        db.commit()
        print(f"Successfully seeded {len(products_data)} products for business {biz.id} ({biz.email})")
    finally:
        db.close()
